...
@AndroidEntryPoint
public class HOrderManagementFragment extends Fragment implements OrderManageAdapter.OnOrderClickListener {

    private FragmentHOrderManageBinding binding;
    private HOrderManagementVM orderManageVM;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        orderManageVM = new ViewModelProvider(this).get(HOrderManagementVM.class);
