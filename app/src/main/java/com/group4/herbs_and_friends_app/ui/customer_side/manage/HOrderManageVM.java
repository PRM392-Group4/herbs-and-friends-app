...
@HiltViewModel
public class HOrderManageVM extends ViewModel {
    ...
    private void applyFilters() {
        ...
        if (searchQuery != null && !searchQuery.trim().isEmpty()) {
            ...
            filtered = filtered.stream()
                    .filter(order -> order.getId().toLowerCase().contains(query) ||
        ...
        Log.d("HOrderManageVM", "Filtered " + allOrders.size() + " orders down to " + filtered.size());
